...
const STEPS: Step[] = [
  ...
  },
  {
    ...
    how: <>Browse a search yourself, capture the visible results, hit <strong>Copy JSON</strong>, then paste it into <Ref icon="import" iconClass="text-brand">Import capture</Ref> here. Imports are deduped, so re-importing is safe.</>,
